...
Процедура НастроитьПараметрыВыбораЭлементаФормы(МодельОбъекта, ЭлементФормы) Экспорт
...
Процедура НастроитьПараметрыВыбора(МодельОбъекта) Экспорт
	Для Каждого ЭлементКоллекции Из МодельОбъекта.ЭлементыФормы Цикл
		НастроитьПараметрыВыбораЭлементаФормы(МодельОбъекта, ЭлементКоллекции.Значение);
	КонецЦикла;
КонецПроцедуры