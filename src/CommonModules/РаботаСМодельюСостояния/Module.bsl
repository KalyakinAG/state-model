...
//  Конструкирование структуры схемы для построения модели объекта
//
Функция СхемаМодели(Контекст, ПутьКДаннымОбъекта = "Объект", МодульМодели = "") Экспорт
	...
	Схема.Вставить("ЭтоКонтекстФормы", Тип(Контекст) = Тип("ФормаКлиентскогоПриложения"));
	Возврат Схема;
КонецФункции
