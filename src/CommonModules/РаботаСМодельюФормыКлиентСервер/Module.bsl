...
Процедура НастроитьСвойство(Форма, Элемент, Свойство, Значение)
	...
	ИначеЕсли Свойство = "ПоложениеЗаголовка" Тогда
		Элемент.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы[Значение];
	ИначеЕсли Свойство = "ОтображениеСтраниц" Тогда
		Элемент.ОтображениеСтраниц = ОтображениеСтраницФормы[Значение];
