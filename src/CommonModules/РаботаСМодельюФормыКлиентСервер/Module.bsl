	...
	Для Каждого ИдентификаторСвязи Из ЭлементФормы.Параметр.ВходящиеСвязи Цикл
		...
		Если ЗначениеЗаполнено(Параметр) Тогда
			Если ЗначениеЗаполнено(Параметр.ПутьКДанным) Тогда
				// Это связь параметров выбора с реквизитом объекта
			...
			ИначеЕсли ЗначениеЗаполнено(Связь.ПутьКДанным) Тогда
				// Это параметр выбора со значением из другого параметра
			...
			КонецЕсли;
		ИначеЕсли ЗначениеЗаполнено(Связь.ПутьКДанным) Тогда
			// Это параметр выбора с заданным значением связи
